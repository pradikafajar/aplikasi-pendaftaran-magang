        ...
        <div class="content-wrapper ">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <h1 class="m-0 text-dark">Daftar Magang</h1>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{route('dft.create')}}" class="btn btn-primary mb-2">Tambah</a>
                                    <table class="table table-hover table-bordered table-stripped" id="example2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$dft->nama}}</td>
                                                <td>{{$dft->tgl_lhr}}</td>
                                                <td>{{$dft->jenis_klmn}}</td>
                                                <td>{{$dft->alamat}}</td>
                                                <td>{{$dft->asl_sklh}}</td>
                                                <td>{{$dft->instansi_magang}}</td>
                                                <td>{{$dft->tgl_mulai}}</td>
                                                <td>{{$dft->tgl_berakhir}}</td>
                                                <td>{{$dft->no_hp}}</td>
                                                <td>
                                                    <a href="{{route('dft.edit', $dft -> id)}}"
                                                        class="btn btn-primary btn-xs">
                                                        Edit
                                                    </a>
                                                    <a href="{{route('dft.destroy', $dft ->id)}}"
