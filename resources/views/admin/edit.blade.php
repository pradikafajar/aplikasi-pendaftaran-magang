                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('instansi') is-invalid @enderror"
                                     name="instansi" value="{{$home->instansi ?? old('instansi')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('posisi') is-invalid @enderror"
                                     name="posisi" value="{{$home->posisi ?? old('posisi')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('kuota') is-invalid @enderror"
                                     name="kuota" value="{{$home->kuota ?? old('kuota')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('periode') is-invalid @enderror"
                                     name="periode" value="{{$home->periode ?? old('periode')}}">
