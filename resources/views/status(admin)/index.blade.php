            ...
            <div class="sidebar">
                <nav class="pt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active " href="{{url('statuspengajuan')}}">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{route('statuspengajuan.create')}}"
                                    ...
                                    <table class="table table-hover table-bordered table-stripped" id="example2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('statuspengajuan.edit', $status -> id)}}"
                                                        class="btn btn-primary btn-xs">
                                                        Edit
                                                    </a>
                                                    <a href="{{route('statuspengajuan.destroy', $status ->id)}}"
